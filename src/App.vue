...
<template>
  <div class="container-fluid">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark justify-content-between">
        ...
        <nav>
            <ul>
                <li><a href="#"><img class="header_icon" src="/img/Glasses.png"></a></li>
                <li><a href="#"><img class="header_icon" src="/img/User.png"></a></li>
                 <li><a href="#"><img class="header_icon" src="/img/panier.png"></a></li>
